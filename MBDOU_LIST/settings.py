...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
    'MBDOU_INF',
    'corsheaders',  # Убедись, что corsheaders добавлен в INSTALLED_APPS
]
...
MIDDLEWARE = [
    ...
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'corsheaders.middleware.CorsMiddleware',  # Убедись, что corsheaders.middleware.CorsMiddleware добавлен в MIDDLEWARE
]
