...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gmu_converter', '0004_organization_founderauthority'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acts_setting_price', to='gmu_converter.organization', verbose_name='Организация')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codeBasicList', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Код по общероссийскому базовому перечню или федеральному перечню')),
                ('regulatingAct', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Нормативные правовые акты, регулирующие порядок оказания государственной услуги')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='indicators_quality_service', to='gmu_converter.organization', verbose_name='Организация')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codeBasicList', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Код по общероссийскому базовому перечню или федеральному перечню')),
                ('regulatingAct', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Нормативные правовые акты, регулирующие порядок оказания государственной услуги')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='indicators_volume_service', to='gmu_converter.organization', verbose_name='Организация')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codeBasicList', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Код по общероссийскому базовому перечню или федеральному перечню')),
                ('regulatingAct', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Нормативные правовые акты, регулирующие порядок оказания государственной услуги')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='informing_potential_consumers', to='gmu_converter.organization', verbose_name='Организация')),
            ],
            options={
